...
type Hotel struct {
	...
	Stars       uint32      `protobuf:"varint,4,opt,name=stars,proto3" json:"stars,omitempty" db:"stars"`
	...
	Images      StringArray `protobuf:"bytes,8,opt,name=images,proto3,customtype=StringArray" json:"images" db:"images"`
	CreatedOn   *time.Time  `protobuf:"bytes,9,opt,name=created_on,json=createdOn,proto3,stdtime" json:"created_on,omitempty" db:"created_on"`
	UpdatedOn   *time.Time  `protobuf:"bytes,10,opt,name=updated_on,json=updatedOn,proto3,stdtime" json:"updated_on,omitempty" db:"updated_on"`
}
...
type RoomType struct {
	...
	Images       StringArray `protobuf:"bytes,9,opt,name=images,proto3,customtype=StringArray" json:"images" db:"images"`
...
type Boat struct {
	...
	Images    StringArray `protobuf:"bytes,4,opt,name=images,proto3,customtype=StringArray" json:"images" db:"images"`
...
func (m *Boat) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Boat.Unmarshal(m, b)
}
...
func (m *Boat) XXX_Size() int {
	return xxx_messageInfo_Boat.Size(m)
}
...
func (m *TripTemplate) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TripTemplate.Unmarshal(m, b)
}
...
func (m *TripTemplate) XXX_Size() int {
	return xxx_messageInfo_TripTemplate.Size(m)
}
...
type Trip struct {
	...
	CreatedOn           *time.Time `protobuf:"bytes,8,opt,name=created_on,json=createdOn,proto3,stdtime" json:"created_on,omitempty" db:"created_on"`
	UpdatedOn           *time.Time `protobuf:"bytes,9,opt,name=updated_on,json=updatedOn,proto3,stdtime" json:"updated_on,omitempty" db:"updated_on"`
	LastReservationDate *time.Time `protobuf:"bytes,11,opt,name=last_reservation_date,json=lastReservationDate,proto3,stdtime" json:"last_reservation_date,omitempty" db:"last_reservation_date"`
}
...
type DiveMaster struct {
	...
	AgencyId  uint64       `protobuf:"varint,5,opt,name=agency_id,json=agencyId,proto3" json:"agency_id,omitempty" db:"agency_id"`
	// repeated string documents = 6 [(gogoproto.moretags) = "db:\"documents\""];
	Documents StringArray `protobuf:"bytes,6,opt,name=documents,proto3,customtype=StringArray" json:"documents" db:"documents"`
	CreatedOn *time.Time  `protobuf:"bytes,7,opt,name=created_on,json=createdOn,proto3,stdtime" json:"created_on,omitempty" db:"created_on"`
	UpdatedOn *time.Time  `protobuf:"bytes,8,opt,name=updated_on,json=updatedOn,proto3,stdtime" json:"updated_on,omitempty" db:"updated_on"`
}
...
func (m *DiveMaster) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DiveMaster.Unmarshal(m, b)
}
...
func (m *DiveMaster) XXX_Size() int {
	return xxx_messageInfo_DiveMaster.Size(m)
}
...
// DiveMasterTrip entity
type DiverMasterTrip struct {
	Id           uint64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" db:"id"`
	DiveMasterId uint64 `protobuf:"varint,2,opt,name=dive_master_id,json=diveMasterId,proto3" json:"dive_master_id,omitempty" db:"dive_master_id"`
	TripId       uint64 `protobuf:"varint,3,opt,name=trip_id,json=tripId,proto3" json:"trip_id,omitempty" db:"trip_id"`
}

func (m *DiverMasterTrip) Reset()      { *m = DiverMasterTrip{} }
func (*DiverMasterTrip) ProtoMessage() {}
func (*DiverMasterTrip) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf50d946d740d100, []int{14}
}
func (m *DiverMasterTrip) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DiverMasterTrip) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DiverMasterTrip.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DiverMasterTrip) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DiverMasterTrip.Merge(m, src)
}
func (m *DiverMasterTrip) XXX_Size() int {
	return m.Size()
}
func (m *DiverMasterTrip) XXX_DiscardUnknown() {
	xxx_messageInfo_DiverMasterTrip.DiscardUnknown(m)
}

var xxx_messageInfo_DiverMasterTrip proto.InternalMessageInfo

func (m *DiverMasterTrip) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *DiverMasterTrip) GetDiveMasterId() uint64 {
	if m != nil {
		return m.DiveMasterId
	}
	return 0
}

func (m *DiverMasterTrip) GetTripId() uint64 {
	if m != nil {
		return m.TripId
	}
	return 0
...
type Reservation struct {
	...
	Price     float32    `protobuf:"fixed32,4,opt,name=price,proto3" json:"price,omitempty" db:"price"`
	CreatedOn *time.Time `protobuf:"bytes,5,opt,name=created_on,json=createdOn,proto3,stdtime" json:"created_on,omitempty" db:"created_on"`
	UpdatedOn *time.Time `protobuf:"bytes,6,opt,name=updated_on,json=updatedOn,proto3,stdtime" json:"updated_on,omitempty" db:"updated_on"`
}
...
type TripComment struct {
	...
	Stars         uint32     `protobuf:"varint,3,opt,name=stars,proto3" json:"stars,omitempty" db:"stars"`
...
func init() {
	...
	proto.RegisterType((*DiverMasterTrip)(nil), "entity.DiverMasterTrip")
...
var fileDescriptor_cf50d946d740d100 = []byte{
	...
	,
}
...
func (this *DiverMasterTrip) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*DiverMasterTrip)
	if !ok {
		that2, ok := that.(DiverMasterTrip)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.DiveMasterId != that1.DiveMasterId {
		return false
	}
...
func (this *DiverMasterTrip) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&entity.DiverMasterTrip{")
	s = append(s, "Id: "+fmt.Sprintf("%#v", this.Id)+",\n")
	s = append(s, "DiveMasterId: "+fmt.Sprintf("%#v", this.DiveMasterId)+",\n")
...
func (m *Trip) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastReservationDate != nil {
		n11, err11 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.LastReservationDate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.LastReservationDate):])
		if err11 != nil {
			return 0, err11
		}
		i -= n11
	...
	if m.UpdatedOn != nil {
		n12, err12 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.UpdatedOn, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.UpdatedOn):])
		if err12 != nil {
			return 0, err12
		}
		i -= n12
	...
	if m.CreatedOn != nil {
		n13, err13 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.CreatedOn, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.CreatedOn):])
		if err13 != nil {
			return 0, err13
		}
		i -= n13
	...
	if m.ToDate != nil {
		n14, err14 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ToDate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ToDate):])
		if err14 != nil {
			return 0, err14
		}
		i -= n14
	...
	if m.FromDate != nil {
		n15, err15 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.FromDate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.FromDate):])
		if err15 != nil {
			return 0, err15
		}
		i -= n15
...
func (m *DiverMasterTrip) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DiverMasterTrip) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DiverMasterTrip) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.DiveMasterId != 0 {
		i = encodeVarintEntity(dAtA, i, uint64(m.DiveMasterId))
		i--
		dAtA[i] = 0x10
	}
	if m.Id != 0 {
...
func (m *TripComment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Stars != 0 {
		i = encodeVarintEntity(dAtA, i, uint64(m.Stars))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Comment) > 0 {
...
func (m *DiverMasterTrip) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.DiveMasterId != 0 {
		n += 1 + sovEntity(uint64(m.DiveMasterId))
	}
	if m.TripId != 0 {
...
func (this *DiverMasterTrip) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DiverMasterTrip{`,
		`Id:` + fmt.Sprintf("%v", this.Id) + `,`,
		`DiveMasterId:` + fmt.Sprintf("%v", this.DiveMasterId) + `,`,
...
func (m *DiverMasterTrip) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DiverMasterTrip: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DiverMasterTrip: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DiveMasterId", wireType)
			}
			m.DiveMasterId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DiveMasterId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
