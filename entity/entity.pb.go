...
type Agency struct {
	...
	CreatedOn *time.Time `protobuf:"bytes,6,opt,name=created_on,json=createdOn,proto3,stdtime" json:"created_on,omitempty" db:"created_on"`
	UpdatedOn *time.Time `protobuf:"bytes,7,opt,name=updated_on,json=updatedOn,proto3,stdtime" json:"updated_on,omitempty" db:"updated_on"`
}
...
type Diver struct {
	...
	Documents []string     `protobuf:"bytes,8,rep,name=documents,proto3" json:"documents,omitempty" db:"documents"`
...
func (m *Diver) GetDocuments() []string {
	if m != nil {
		return m.Documents
	}
	return nil
...
var fileDescriptor_cf50d946d740d100 = []byte{
	...
	,
}
...
func (m *Agency) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AccountId != 0 {
		i = encodeVarintEntity(dAtA, i, uint64(m.AccountId))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Phone) > 0 {
...
func (m *Diver) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BirthDate) > 0 {
		...
		i = encodeVarintEntity(dAtA, i, uint64(len(m.BirthDate)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Phone) > 0 {
...
func (m *Trip) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ToDate != nil {
		n25, err25 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ToDate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ToDate):])
		if err25 != nil {
			return 0, err25
		}
		i -= n25
	...
	if m.FromDate != nil {
		n26, err26 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.FromDate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.FromDate):])
		if err26 != nil {
			return 0, err26
		}
		i -= n26
...
func (m *HotelComment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UpdatedOn != nil {
		...
		i -= n33
		i = encodeVarintEntity(dAtA, i, uint64(n33))
		i--
		dAtA[i] = 0x32
	}
	if m.CreatedOn != nil {
		...
		i -= n34
		i = encodeVarintEntity(dAtA, i, uint64(n34))
		i--
		dAtA[i] = 0x2a
	}
	if m.ReservationId != 0 {
...
func (m *LiveaboardComment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UpdatedOn != nil {
		...
		i -= n35
		i = encodeVarintEntity(dAtA, i, uint64(n35))
		i--
		dAtA[i] = 0x32
	}
	if m.CreatedOn != nil {
		...
		i -= n36
		i = encodeVarintEntity(dAtA, i, uint64(n36))
		i--
		dAtA[i] = 0x2a
	}
	if m.ReservationId != 0 {
...
func (m *Agency) Size() (n int) {
	...
	if m.AccountId != 0 {
		n += 1 + sovEntity(uint64(m.AccountId))
	}
	if m.AddressId != 0 {
