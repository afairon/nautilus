...
import 'source_context.pb.dart' as $6;

import 'type.pbenum.dart' as $8;
...
class Api extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Api', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$8.Option>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $8.Option.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
    ..aOM<$6.SourceContext>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceContext', subBuilder: $6.SourceContext.create)
    ..pc<Mixin>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mixins', $pb.PbFieldType.PM, subBuilder: Mixin.create)
    ..e<$8.Syntax>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $8.Syntax.SYNTAX_PROTO2, valueOf: $8.Syntax.valueOf, enumValues: $8.Syntax.values)
  ...
  factory Api({
    ...
    $core.Iterable<$8.Option>? options,
    $core.String? version,
  ...
  @$pb.TagNumber(3)
  $core.List<$8.Option> get options => $_getList(2);
  ...
  @$pb.TagNumber(5)
  $6.SourceContext get sourceContext => $_getN(4);
  @$pb.TagNumber(5)
  set sourceContext($6.SourceContext v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSourceContext() => $_has(4);
  @$pb.TagNumber(5)
  void clearSourceContext() => clearField(5);
  @$pb.TagNumber(5)
  $6.SourceContext ensureSourceContext() => $_ensure(4);

  @$pb.TagNumber(6)
  $core.List<Mixin> get mixins => $_getList(5);

  @$pb.TagNumber(7)
  $8.Syntax get syntax => $_getN(6);
  @$pb.TagNumber(7)
  set syntax($8.Syntax v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class Method extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Method', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$8.Option>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $8.Option.create)
    ..e<$8.Syntax>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $8.Syntax.SYNTAX_PROTO2, valueOf: $8.Syntax.valueOf, enumValues: $8.Syntax.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $core.List<$8.Option> get options => $_getList(5);
