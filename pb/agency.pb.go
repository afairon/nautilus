...
type Agency struct {
	...
	CompanyImages [][]byte `protobuf:"bytes,5,rep,name=company_images,json=companyImages,proto3" json:"company_images,omitempty"`
}
...
func (m *Agency) GetDocument() []byte {
	if m != nil {
		return m.Document
	}
	return nil
...
func (m *Agency) GetCompanyImages() [][]byte {
	if m != nil {
		return m.CompanyImages
	}
	return nil
}
...
var fileDescriptor_614a4be5fd9deed0 = []byte{
	...
	,
}
...
func (this *Agency) Equal(that interface{}) bool {
	...
	if len(this.CompanyImages) != len(that1.CompanyImages) {
		return false
	}
	for i := range this.CompanyImages {
		if !bytes.Equal(this.CompanyImages[i], that1.CompanyImages[i]) {
			return false
		}
	}
	return true
...
func (this *Agency) GoString() string {
	...
	s = append(s, "CompanyImages: "+fmt.Sprintf("%#v", this.CompanyImages)+",\n")
	s = append(s, "}")
...
func (m *Agency) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CompanyImages) > 0 {
		for iNdEx := len(m.CompanyImages) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CompanyImages[iNdEx])
			copy(dAtA[i:], m.CompanyImages[iNdEx])
			i = encodeVarintAgency(dAtA, i, uint64(len(m.CompanyImages[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.Document) > 0 {
		...
		i = encodeVarintAgency(dAtA, i, uint64(len(m.Document)))
		i--
		dAtA[i] = 0x22
	}
	if m.Address != nil {
...
func (this *Agency) String() string {
	...
	s := strings.Join([]string{`&Agency{`,
		...
		`CompanyImages:` + fmt.Sprintf("%v", this.CompanyImages) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Agency) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompanyImages", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CompanyImages = append(m.CompanyImages, make([]byte, postIndex-iNdEx))
			copy(m.CompanyImages[len(m.CompanyImages)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
